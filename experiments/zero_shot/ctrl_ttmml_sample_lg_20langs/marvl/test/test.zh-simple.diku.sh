#!/bin/bash
#SBATCH --job-name=zh-t_mar_lgsample
#SBATCH --ntasks=1 --cpus-per-task=20
#SBATCH --mem=30GB
#SBATCH -p gpu --gres=gpu
#SBATCH --time=2:00:00
#SBATCH --output="logs/marvl-zh-simple.sample_lg.step_100000.batch_size_256.langs_20.out"
...
TETASK=MaRVL${LANG}-simple-${STRATEGY}-batch_size_${TRAIN_BATCH_SIZE}-step_${STEP}-langs_${LANGS}
...
TEXT_PATH=$DIR/data/zero-shot/marvl/annotations/marvl-${LANG}-simple.jsonl
