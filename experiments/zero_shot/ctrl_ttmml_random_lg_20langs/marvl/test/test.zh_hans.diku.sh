#!/bin/bash
#SBATCH --job-name=zh-hans_mar_random_lg
#SBATCH --ntasks=1 --cpus-per-task=20
#SBATCH --mem=30GB
#SBATCH -p gpu --gres=gpu:titanrtx:1
#SBATCH --time=2:00:00
#SBATCH --output="logs/marvl-zh_hans.random_lg.step_100000.batch_size_256.langs_20.out"
...
TETASK=MaRVL${LANG}_hans-${STRATEGY}-batch_size_${TRAIN_BATCH_SIZE}-step_${STEP}-langs_${LANGS}
...
TEXT_PATH=$DIR/data/zero-shot/marvl/annotations/marvl-${LANG}_hans.jsonl
