...
#SBATCH --output="pretrain-cc.multilingual.random-lg.prt-20langs.continuePT1.log"
...
RESUME_FILE=$DIR/checkpoints/iglue/pretrain/ctrl_ttmml_${STRATEGY}_${LANGS}langs/${MODEL_CONFIG}/train_batch_size_${TRAIN_BATCH_SIZE}/${TETASK}/ctrl_xuniter_base/pytorch_ckpt_latest.tar
